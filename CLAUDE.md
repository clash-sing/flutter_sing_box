...
This project is indexed by GitNexus as **flutter_sing_box** (307 symbols, 303 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
