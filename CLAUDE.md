...
This project is indexed by GitNexus as **flutter_sing_box** (2424 symbols, 4597 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
