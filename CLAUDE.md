...
This project is indexed by GitNexus as **flutter_sing_box** (2117 symbols, 3855 relationships, 96 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
