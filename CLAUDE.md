...
This project is indexed by GitNexus as **flutter_sing_box** (2319 symbols, 4310 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
