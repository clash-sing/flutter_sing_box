...
This project is indexed by GitNexus as **flutter_sing_box** (2485 symbols, 4597 relationships, 126 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
