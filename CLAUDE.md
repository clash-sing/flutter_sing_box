...
This project is indexed by GitNexus as **flutter_sing_box** (2539 symbols, 4862 relationships, 141 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
